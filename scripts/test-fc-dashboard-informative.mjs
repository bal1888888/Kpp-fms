...
ok(dash.includes("fc-chart.js?v=20260912f"),"dashboard should use new FC asset version");
ok(log.includes("fc-chart.js?v=20260912f"),"logsheet should use new FC asset version");
