...
ok(dash.includes("fc-chart.js?v=20260912e"),"dashboard should use new FC asset version");
ok(log.includes("fc-chart.js?v=20260912e"),"logsheet should use new FC asset version");
